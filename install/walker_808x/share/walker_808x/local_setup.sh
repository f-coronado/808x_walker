...
: ${AMENT_CURRENT_PREFIX:="/home/fabrizzio/ros2_ws/src/walker_808x/install/walker_808x"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/walker_808x/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/walker_808x/environment/path.sh"
